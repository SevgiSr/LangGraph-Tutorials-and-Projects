...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            # Pass the user input and the conversation config to the bot
            ai_response = bot.get_response(user_input, config)
    ...
    # The `finally` block for saving is removed because memory is now handled by the checkpointer.
